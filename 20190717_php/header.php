...
<head>
	...
	<style>
		*{padding: 0; margin: 0;}
		...
		#sub02_content #sub_section{width: 100%; height: 2000px; background-color:black;}

		#sub03_content{width: 1200px; margin: 0 auto;}
		#sub03_content #sub_section{width: 100%; height: 2000px; background-color:yellow;}

		#sub04_content{width: 1200px; margin: 0 auto;}
		#sub04_content #sub_section{width: 100%; height: 2000px; background-color:khaki;}
	</style>
</head>
<body>
